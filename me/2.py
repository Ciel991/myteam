...
print "BY: TEAM ELITE DON'T ASK ME HOW TO MAKE A BABY"
reload(sys)
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""Owner : https://line.me/ti/p/%40luw8183j""",
    "lang":"JP",
    "comment":"""Owner : https://line.me/ti/p/%40luw8183j""",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#--------------------------
                ...
                gid = cl.getGroupIdsJoined()
                for i in gid:
                    cl.sendText(i,"======[BROADCAST]======\n\n"+bc+"\n\nMy Contact: https://line.me/ti/p/%40luw8183j")
#--------------------------------------------------------
...
#------------------------------------------------------------------
            elif msg.text in ["/Clearban","Clear ban"]:
               if msg.from_ in admin:
                wait["blacklist"] = {}
