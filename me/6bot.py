# -*- coding: utf-8 -*-
#TEAMELITEBYCIEL jngn ubah creator hargai creator ty
...
╚═════════════════════════
"""
tjia="u63b477a73bc4dc8f08dd9a2ae572ad14"
...
Creator=["u83c0edf4fcac8f4baf169d3d69edff71"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment1":"Lucu lo lucu",
    "comment2":"Lucu lo lucu",
    "comment3":"Lucu lo lucu",
    "comment4":"Lucu lo lucu",
    "comment5":"Bot Auto Copyright ©By : Ciel nContact Me : 👉 https://line.me/ti/p/%40luw8183j",    
    "commentOn":True,
    "commentBlack":{},
    "message":"Thx For Add Me (^_^)\nAdd my official account https://line.me/ti/p/%40luw8183j",    
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Qr":{},
    ...
    try:
        ...
        if op.type == 17:
          if wait["Sambutan"] == True:
            ...
            cl.sendMessage(c)
            cl.sendText(op.param1,"Hallo " + cl.getContact(op.param2).displayName + "\nWelcome To ☞ " + str(ginfo.name) + " ☜" + "\nAdd my creator ^_^ https://line.me/ti/p/%40luw8183j")
	 ...
	 if wait["Ghost"] == True:
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Sekali lagi nge tag gw sumpahin jomblo seumur hidup!","Dont Tag!! Lagi Sibuk",cName + " Ngapain Ngetag?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja","Tag Mulu Lo Anjirr!","Ciel Lagi Off", cName + " Kenapa Tag? Kangen?","Ciel Lagi molor\nJangan Di Tag Asu" + cName, "Jangan Suka Tag Gua " + cName, "Kamu Siapa " + cName + "?", "Ada Perlu Apa " + cName + "?","Woii " + cName + " Jangan Ngetag, Riibut!"]
                     ret_ = random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
		...
		msg.contentMetadata = {'mid': 'u83c0edf4fcac8f4baf169d3d69edff71'}
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Add my creator(^_^)")
		
            elif msg.text in ["Admin","admin"]:
                msg.contentType = 13
                admin1 = "u63b477a73bc4dc8f08dd9a2ae572ad14"
                ...
                random.choice(KAC).sendMessage(msg)                
		random.choice(KAC).sendText(msg.to,"My admin")	
              ...
              if msg.from_ in Creator:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.append(target)
                            cl.sendText(msg.to,"Admin Ciel Ditambahkan")
                        except:
                            pass
              ...
              if msg.from_ in Creator:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            cl.sendText(msg.to,"Admin Ciel Dihapus")
                        except:
                            pass
		...
		gCreator = ginfo.creator.mid
                ...
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Itu Yang Buat Grup Ini https://line.me/ti/p/%40luw8183j")
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus Ciel")
...
#		    cl.sendText(msg.to,"Khusus Ciel")
	        ...
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    ...
                    if len(dataResult) > 0:
                        ...
                        subprocess.Popen("echo '' > dataSeen/"+msg.to+".txt", shell=True, stdout=subprocess.PIPE)
                        cl.sendText(msg.to, "ADD MY CREATOR https://line.me/ti/p/%40luw8183j")                        
                    else:
		...
		if msg.from_ in Creator:
		    for i in gid:
			cl.sendText(i,"=======[BROADCAST BY CIEL]=======\n\n"+bc+"\n\nContact Me : https://line.me/ti/p/%40luw8183j")
            ...
            elif msg.text in ["All join","Join all","Ciel join"]:
		if msg.from_ in admin:
		...
		try:
		    ...
		    wait["Leave"] = False
		          ...
		          cl.sendText(msg.to,"Bilang Dulu Sama CIEL jngn tengil")		    
		    

            elif msg.text in ["Absen"]:
		cl.sendText(msg.to,"Bentar w lg ngebokep")
                ki.sendText(msg.to,"Bentar w lg cebok")
                kk.sendText(msg.to,"Lima menit lagi masih ngantuk ciel")
                kc.sendText(msg.to,"My Creator https://line.me/ti/p/%40luw8183j")
                kr.sendText(msg.to,"Semua lg gila ciel")
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
            ...
            elif "My copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("My copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = cl.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ...
                               ki.sendText(msg.to, "Done ciel)")
                            except Exception as e:
                                print e
            elif "A2 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("A2 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kk.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ...
                               kk.sendText(msg.to, "Done ciel")
                            except Exception as e:
                                print e
                                
            elif "A3 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("A3 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kc.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ...
                               kc.sendText(msg.to, "Done ciel")
                            except Exception as e:
                                print e                                

            elif "A4 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("A4 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kr.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                ...
                try:
                    ...
                    cl.sendText(msg.to, "Succes ciel")
                except Exception as e:
                    cl.sendText(msg.to, str(e))
...
#              if msg.from_ in admin:
		...
		cl.sendText(msg.to,"Add my creator: https://line.me/ti/p/%40luw8183j")
            ...
            elif msg.text in ["A1 acc invite"]:
                if msg.from_ in admin:
                    gid = ki.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["A2 acc invite"]:
                if msg.from_ in admin:
                    gid = kk.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["A3 acc invite"]:
                if msg.from_ in admin:
                    gid = kc.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["A4 acc invite"]:
                if msg.from_ in admin:
