...
print "TEAM ELITE DON'T ASK ME HOW TO MAKE A BABY"
reload(sys)
...
[😹]Bye all➡️ Menyuruh Astro pulang
[😹]Ciel restart➡️ Menyuruh Astro pulang dari semua grup
[😹]Speed➡️ Cek Speed Ciel
[😹]Hancurin lagi➡️ Speed Fake ciel
[😹]Turunin➡️ Speed Fake Ciel """
...
wait = {
    ...
    "lang":"JP",
    "comment":"AutoLike by Team Elite https://line.me/ti/p/%40luw8183j",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#==================================================
				...
				cl.sendMessage(msg)
				cl.sendText(msg.to,"Add my Creator")
            elif "Id" == msg.text:
                key = msg.to
...
#=======================================================
              ...
              if msg.from_ in owner:
               ...
               if msg.from_ in owner:  
                 wait["kickJoin"] = True
                 cl.sendText(msg.to,"Don't Join in group")
...
#===============================================
                ...
                cl.sendText(msg.to, "%sseconds" % (elapsed_time))
                print "[Command]Speed palsu executed"				
            elif "Sp fake" in msg.text:
                cl.sendText(msg.to, "Speed fake....")
                start = time.time()
                time.sleep(0.02)
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "%sseconds" % (elapsed_time))
...
#========================================
            elif msg.text in ["Team Elite backup","Ciel backup"]:
                try:
...
#---------------FUNGSI RATAIN GRUP TANPA KICK SESAMA BOT/Admin/Bots----------#
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    ks.sendText(msg.to,"Team Elite ? It's me !! don't kick me out from the group")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': 'u63b477a73bc4dc8f08dd9a2ae572ad14'}
                    ks.sendMessage(msg)
                    targets = []
                        ...
                        for target in targets:
                          if target not in Bots:
                            try:
                                ...
                                kl.sendText(msg.to,"Byee Culun!")
                                km.sendText(msg.to,"Byee Culun!")
                                kl.sendText(msg.to,"Byee Culun!")
                                km.sendText(msg.to,"Byee Culun!")
#================================================
#========================================
...
#-----------------------------------------------
                ...
                jawab = ("Ya","Tidak","Mungkin","Bisa jadi"," Capek aku pantek!","Mikir")
...
#========================================
            elif msg.text in ["Ciel come",".","Team Elite ?"]:
...
#===========================================================
            elif msg.text in ["Restart all bot","Ciel restart"]
                if msg.from_ in admin:
				...
				for i in gid:
					...
					kt.leaveGroup(i)
				if wait["lang"] == "JP":
					ki.sendText(msg.to,"We are Team Elite https://line.me/ti/p/%40luw8183j")
				else:
					ki.sendText(msg.to,"He declined all invitations")


            elif msg.text in ["Bye all",",","Bye ciel"]
               if msg.from_ in admin:              
                 if msg.toType == 2:                
                   X = cl.getGroup(msg.to)
                 try:
            ...
            elif msg.text in ["C @bye","C1 pulang","C1 bye"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     ki.leaveGroup(msg.to)
                     ...
                     pass
            elif msg.text in ["C2 @bye","C2 pulang","C2bye"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     kk.leaveGroup(msg.to)
                     ...
                     pass
            elif msg.text in ["C3 @bye","C3 pulang","C3 bye"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     kc.leaveGroup(msg.to)
                     ...
                     pass
            elif msg.text in ["C4 @bye","C4 pulang","C4 bye"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     kd.leaveGroup(msg.to)
                     ...
                     pass
            elif msg.text in ["C5 @bye","C5 pulang","C5 bye"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     ke.leaveGroup(msg.to)
...
#==========================================
                ...
                if msg.from_ in admin:
                    ...
                    kicker.sendText(msg.to,"Byee Culun!")
...
#=============================================
                ...
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "%s<==TEAMELITESERVER https://line.me/ti/p/%40luw8183j" % (elapsed_time))
...
#============================================
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        print error
            elif msg.text in ["C1tag","Ciel1 tag"]:
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        print error
            elif msg.text in ["Ctag","Ciel2 tag"]:
                if msg.toType == 2:
