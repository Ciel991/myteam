...
#JANGAN UBAH SCRIPT NYA , KALO MAU UBAH IZIN DULU KE http://line.me/ti/p/~phantom70 !!!!!!!!
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Follow my instagram @yatogamitohka.1 and add my official account creator by ciel : https://line.me/ti/p/%40luw8183j",
    "lang":"JP",
...
#----------------------[Masukin Semua SC Yang Llu Pengen Disini]----------------------#
        if op.type == 25:
            msg = op.message
